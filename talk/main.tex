...
\begin{coqs}
typing		<==		typdefctx |times 	ll_typdefctx |times 	phi |times 	gamma |times 	trm |times	typ
\end{coqs}
...
%------------------------------------------------------------------------------
\begin{frame}[fragile]
\frametitle{Language overview - type soundness}

An example of a theorem that we proved as a sanity check:

\begin{coqs}
Theorem type_soundness : forall C LLC m t v T,
  red C LLC nil empty t m v ->
  typing C LLC empty nil t T ->
  exists f, typing_val C LLC f v T 
